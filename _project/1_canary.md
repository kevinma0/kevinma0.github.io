...
permalink: /canary
title: "Canary Digital Experiences"
description: "I joined home security startup Canary to rethink various aspects of the digital experience."
img: "thumb_audio.jpg"
...
---
<div class="pv5 cf">
<h1 class="fw7 f1 w-100 mt2 mb3 font-primary font-dark lh-title">{{ page.title }}</h1>
</div>

Since the beginning—2014, the Canary team added features to the app at a rapid pace, prioritizing execution over a holistic approach. Over time, the app went from supporting a single device, to multiple devices in multiple locations with multiple users.
...
<img class="w-100 mt4 mt5-ns db" src="http://mrmrs.github.io/photos/013.jpg" alt="Photo of the foundations of a building on a cliff overlooking a lighthouse.">
